    ...
    <Container id="vote-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        <meta
          ...
          content="Vote using xMINT on community created proposals."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.mistswap.fi/xmint-governance.png" />
        ...
        <meta key="og:image" property="og:image" content="https://app.mistswap.fi/xmint-governance.png" />
        <meta
          key="og:description"
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Vote using xMINT on community created proposals.`)}
              </div>
            </div>
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`View proposals and vote on them using your xMINT. The amount of xMINT you hold at the snapshot block determines your vote weight. You may only vote once per proposal.`)}
            </div>
          </div>
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image src="/xmint-governance.png" alt="xMINT Governance" width="100%" height="100%" layout="responsive" />
          </div>
        </div>
        <div className="flex justify-center mb-6">
