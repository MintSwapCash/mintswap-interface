...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from '@mintswapcash/sdk'
...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Mint</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the MINTswap AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
