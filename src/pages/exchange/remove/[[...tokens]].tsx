...
import { ChainId, Currency, NATIVE, Percent, WNATIVE, WNATIVE_ADDRESS } from '@mintswapcash/sdk'
  ...
  */
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | Mint</title>
        <meta key="description" name="description" content="Remove liquidity from the MINTswap AMM" />
      </Head>
                        ...
                        {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                          <RowBetween className="text-sm">
                            {oneCurrencyIsETH ? (
                              ...
                              <Link
                                href={`/remove/${currencyA?.equals(WNATIVE[chainId]) ? 'MINTME' : currencyIdA}/${
                                  currencyB?.equals(WNATIVE[chainId]) ? 'MINTME' : currencyIdB
                                }`}
                              >
